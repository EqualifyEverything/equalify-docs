# Manage user access (for Admins)
This page explains how to manage system access, including adding new users, changing permissions, and removing accounts.
...
1. The change is immediate, and a confirmation will appear. No "Save" button is required. The user will see the change the next time they login to Equalify.
