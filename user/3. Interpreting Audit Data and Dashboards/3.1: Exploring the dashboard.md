...
Use this **centralized Dashboard** to monitor your digital accessibility. We designed it to help you identify and track blockers across your experiences.
Think of this page as a "health check" for your site’s inclusivity. Below are the key sections you’ll need to navigate.
...
- **Notifications:** This list shows all email addresses that receive the reports. You can add more workspace members using the "Add Another Email" button.
