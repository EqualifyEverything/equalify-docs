# Setting up custom chart and table views "Tuning."
This page is intended for **Project Leads, Accessibility Specialists, and Developers** to refine report data by removing "noise". Before sharing a report with stakeholders, it is helpful to tune your data. An out-of-the-box scan may contain "noise," such as false positives or template-level issues, that can overwhelm a reader and obscure the most critical fixes. By reviewing and refining your report, you ensure that stakeholders receive a clear, actionable list of blockers rather than clutter.
## Ignoring Blockers
...
```important
⚠️ Important: Ignoring blockers does not retroactively remove the issue. Only impacts current and future reports.
```
