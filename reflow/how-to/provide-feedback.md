...
Both options are available from the [web app](use-the-web-app) at `reflow.equalify.uic.edu` — via the **Feedback** button that appears once a conversion finishes.
