...
- [API Reference](api-reference.md) — REST endpoints, authentication, SSE streaming
- [Architecture](architecture.md) — system components, data flow, infrastructure
- [Contributing](contributing.md) — development setup, testing, project structure
